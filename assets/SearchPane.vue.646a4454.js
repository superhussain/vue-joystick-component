...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit }) {
    const props = __props;
    const DocSearchData = () => __vitePreload(() => import("./search-docs-data.5112ebf2.js"), true ? ["./search-docs-data.5112ebf2.js","./vendor.9201be76.js"] : void 0, import.meta.url);
    function close() {
      emit("close");
    }
    const input = ref();
