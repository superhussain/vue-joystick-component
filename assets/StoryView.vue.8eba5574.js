import { b as useRoute, c as computed, d as defineComponent, u as useCssVars, a as unref, a8 as toRefs, r as ref, o as openBlock, e as createElementBlock, f as createVNode, w as withCtx, I as Icon, n as normalizeClass, g as createBaseVNode, t as toDisplayString, i as defineStore, j as useStorage, x as resolveDirective, y as withDirectives, a9 as useRouter, aa as useResizeObserver, l as resolveComponent, q as createBlock, h as createCommentVNode, G as normalizeStyle, a0 as withModifiers, A as pushScopeId, B as popScopeId, k as watch, Y as renderSlot, m as withKeys, z as createTextVNode, F as Fragment, p as renderList, J as onMounted, ab as vModelText, $ as onUnmounted, ac as VTooltip, ad as createStaticVNode, s as useEventListener, a6 as SANDBOX_READY, ae as EVENT_SEND, a3 as STATE_SYNC, a7 as applyState, a4 as PREVIEW_SETTINGS_SYNC, af as toRaw, W as mergeProps, ag as Dropdown, ah as clone, ai as omit, aj as useTimeoutFn, ak as onClickOutside, v as isRef, al as nextTick, am as Qg, an as Ig, ao as Fg, ap as $g, X as resolveDynamicComponent, E as reactive, V as watchEffect, U as markRaw, aq as shallowRef, ar as unindent, as as getHighlighter, at as Gg, T as Transition, a5 as h, au as onBeforeUnmount } from "./vendor.95d36a40.js";
import { b as base, u as useStoryStore } from "./story.aa2c1cf5.js";
import { u as useScrollOnActive, B as BaseListItemLink, _ as _export_sfc, i as isMobile, b as BaseSplitPane, a as _sfc_main$y } from "./MobileOverlay.vue2.ea2742ed.js";
import { B as BaseEmpty } from "./BaseEmpty.vue.d089c6c7.js";
import { g as getContrastColor, _ as _sfc_main$x, t as toRawDeep } from "./state.79b01160.js";
import { h as histoireConfig, i as isDark, b as clientSupportPlugins } from "./GenericMountStory.vue2.f47deb74.js";
import { useEventsStore } from "./events.621625dc.js";
...
const _sfc_main$s = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit }) {
    ...
    watch(path, () => {
      var _a2;
      var _a, _b;
      dasharray.value = (_a2 = (_b = (_a = path.value).getTotalLength) == null ? void 0 : _b.call(_a)) != null ? _a2 : 21.21;
    });
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        role: "checkbox",
